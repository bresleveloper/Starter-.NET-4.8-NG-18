...
namespace Starter_.NET_4._8_NG_18.App_Data
{
    public class DAL
    {
        ...
        static DAL()
        {
            ...
            switch (machineName)
            {
                case "JIl7fK5BRewsZA"://devName2
                    ConStr = "Server=JIL7FK5BREWSZA;Database=MyDBName;Trusted_Connection=True;";
                    break;
                case "DESKTOP-95806M1"://devName2
                    ConStr = "Server=localhost;Database=MyDBName;Trusted_Connection=True;";
                    break;
                case "IBLT-4"://devName2
                    ConStr = "Server=localhost\\mssqlserver_2022;Database=MyDBName;UID=sa;PWD=123;";
                    break;
                default:
        ...
        public static int insert<T>(string tableName, T data, string idName = null)
        {
            if (idName == null)
            {
